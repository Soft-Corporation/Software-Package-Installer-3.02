...
Public Class Informazioni_di_Software_Package_Installer
    ...
    Private Sub Label7_Click(sender As Object, e As EventArgs) Handles Label7.Click
        'download.DownloadFileAsync(New Uri("ftp://SC@192.168.1.22/Software%20Package%20Installer%20B%201803/Ver.txt"), Application.StartupPath & "\Updater.txt")

        'Timer1.Start()
        'Timer2.Start()
        'Timer3.Start()
        MsgBox("A causa di un grandissimo malfunzionamento al server non è possibile eseguire la verifica degli aggiornamenti. Il servizio di verifica degli aggiornamenti tornerà a gennaio 2023")
