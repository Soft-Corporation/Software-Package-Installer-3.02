...
Public Class Filezilla_Server
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_59aa106047984333bbefb21dc3ff61eb.zip"), TextBox1.Text)
        ProgressBar1.Show()
        Panel7.Hide()
        Panel1.Hide()
    End Sub
